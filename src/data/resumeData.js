...
export const skills = {
  ...
  tools: [
    ...
    { name: 'Copilot', level: 90, icon: 'SiGithub' },
  ],
}

export const projects = [
  {
    title: 'AML Data Science Platform',
    description: 'Building a comprehensive data science platform that integrates data from AML system layers and trains multiple machine learning models including False Positive Alarm reduction, Customer Risk scoring, Anomaly Detection, and Graphical User Interface for analytics and reporting.',
    technologies: ['Python', 'ML', 'Data Science', 'AML Systems', 'Risk Management', 'Anomaly Detection', 'Streamlit', 'Snowflake', 'AWS'],
    github: '',
    demo: '',
    image: 'https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=800',
    highlights: [
      'Integrated data from multiple AML system layers',
      'Trained ML models for False Positive Alarm reduction',
      'Customer Risk scoring and Anomaly Detection models',
      'Graphical User Interface for analytics and reporting',
